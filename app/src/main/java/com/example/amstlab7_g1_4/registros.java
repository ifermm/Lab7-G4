package com.example.amstlab7_g1_4;
...
public class registros extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db_reference = FirebaseDatabase.getInstance().getReference().child("Grupos").child("Grupo1");
    ...
    public void mostrarRegistrosPorPantalla(DataSnapshot snapshot){
        ...
        System.out.println(snapshot);
        String tempVal =
                String.valueOf(snapshot.child("uplink_message").child("decoded_payload").child("temp").getValue());
        String humVal =
                String.valueOf(snapshot.child("uplink_message").child("decoded_payload").child("humedad").getValue());
        System.out.println(tempVal);
        System.out.println(humVal);
